...
export default function LoginPage() {
    ...
    const handleOAuth = (provider: string) => {
        window.location.href = api.auth.getOAuthUrl(provider);
    };
        ...
        <div className="w-full animate-fade-in">
            ...
            <div className="mb-12 text-center lg:text-left">
                ...
                <p className="font-body text-muted text-base">
                    Sign in to continue to your knowledge graphs
                </p>
            </div>
            ...
            <Card className="border-border/50 shadow-refined-lg">
                <CardContent className="pt-8">
                        ...
                        <div className="space-y-2.5">
                            <div className="flex items-center justify-between">
                                ...
                                <Link
                                    ...
                                    className="text-sm text-accent hover:text-accent-hover transition-refined font-body"
                                >
                                    Forgot password?
                                </Link>
                            </div>
                    ...
                    <div className="relative my-8">
                        <Separator />
                        <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-card px-3 text-xs text-muted font-body">
                            or continue with
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Button
                            ...
                            className="hover:bg-accent-subtle hover:border-accent"
                        >
                ...
                <CardFooter className="justify-center border-t border-border/50 mt-8 pt-6">
                    <p className="text-sm text-muted font-body">
                        ...
                        <Link href="/register" className="text-accent hover:text-accent-hover transition-refined font-medium">
                            Create account
                        </Link>
                    </p>
                </CardFooter>
